    ...
    >
      ...
      <div className="flex gap-4 items-start">
        <div className="flex-1 min-w-0">
          ...
          {/* Short description - suppress if identical to title */}
          {article.description && 
      ...
      <div className="flex flex-col gap-3 pt-3 border-t border-slate-800/80">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0 flex-wrap">
            {article.companyName && (
              <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-slate-800 text-slate-300 text-[11px] font-medium border border-slate-700/60 truncate">
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-indigo-600/20 hover:bg-indigo-600/35 text-indigo-300 text-xs font-semibold border border-indigo-500/30 transition-all min-h-[44px] cursor-pointer"
            >
            ...
            {article.url && (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-300 text-xs font-semibold border border-slate-700/80 transition-all min-h-[44px] cursor-pointer"
              >
                <span>Source</span>
