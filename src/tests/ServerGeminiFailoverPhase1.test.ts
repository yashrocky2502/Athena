...
describe("Phase 1: Server Gemini Failover & Safety Audit", () => {
  ...
  it("TEST 11: Error logging sanitization (fake API keys and credentials are fully redacted)", () => {
    ...
    const rawError = `Failed request to https://generativelanguage.googleapis.com/v1beta/models/gemini-3.6-flash:generateContent?key=${fakeKey} with Authorization: Bearer secret_token_xyz_12345678`;
